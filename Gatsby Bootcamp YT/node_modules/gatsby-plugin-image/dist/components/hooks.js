...
function getImageData(_a) {
    var baseUrl = _a.baseUrl, urlBuilder = _a.urlBuilder, sourceWidth = _a.sourceWidth, sourceHeight = _a.sourceHeight, _b = _a.pluginName, pluginName = _b === void 0 ? "useGatsbyImage" : _b, _c = _a.formats, formats = _c === void 0 ? ["auto"] : _c, _d = _a.breakpoints, breakpoints = _d === void 0 ? image_utils_1.EVERY_BREAKPOINT : _d, options = _a.options, props = __rest(_a, ["baseUrl", "urlBuilder", "sourceWidth", "sourceHeight", "pluginName", "formats", "breakpoints", "options"]);
