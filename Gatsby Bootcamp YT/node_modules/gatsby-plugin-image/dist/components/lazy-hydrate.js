...
function lazyHydrate(_a, root, hydrated) {
    ...
    var hasLoaded = hooks_1.hasImageLoaded(cacheKey);
    ...
    var component = (react_1["default"].createElement(layout_wrapper_1.LayoutWrapper, { layout: layout, width: width, height: height },
        !hasLoaded && (react_1["default"].createElement(placeholder_1.Placeholder, __assign({}, hooks_1.getPlaceholderProps(placeholder, isLoaded, layout, width, height, wrapperBackgroundColor)))),
        react_1["default"].createElement(main_image_1.MainImage, __assign({}, props, { width: width, height: height, className: imgClassName }, hooks_1.getMainProps(isLoading, hasLoaded || isLoaded, images, loading, toggleIsLoaded, cacheKey, ref, imgStyle)))));
    // Force render to mitigate "Expected server HTML to contain a matching" in develop
    var doRender = hydrated.current || IS_DEV ? react_dom_1.render : react_dom_1.hydrate;
