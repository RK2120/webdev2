...
const warnOnce = (message, key) => {
  let messageId = key !== null && key !== void 0 ? key : message;
...
actions.createServerVisitedPage = chunkName => {
  ...
  if ((_store$getState$visit = store.getState().visitedPages.get(`server`)) === null || _store$getState$visit === void 0 ? void 0 : _store$getState$visit.has(chunkName)) {
