...
const getFilterInput = ({
  ...
  if ((inputTypeComposer === null || inputTypeComposer === void 0 ? void 0 : inputTypeComposer.hasField(`id`)) && (0, _graphql.getNamedType)(inputTypeComposer.getFieldType(`id`)).name === `ID`) {
