...
var aa=objectAssign,ba=react,m=scheduler;function n(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return "Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var q=ba.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
null!==b&&(b.nextEffect=null);break}}else E()>e.tailExpiration&&1<d&&(b.effectTag|=64,f=!0,Le(e,!1),b.expirationTime=b.childExpirationTime=d-1);e.isBackwards?(g.sibling=b.child,b.child=g):(c=e.last,null!==c?c.sibling=g:b.child=g,e.last=g);}if(null!==e.tail){0===e.tailExpiration&&(e.tailExpiration=E()+500);c=e.tail;e.rendering=c;e.tail=c.sibling;e.lastEffect=b.lastEffect;c.sibling=null;e=I.current;e=f?e&1|2:e&1;z(I,e);b=c;break a}break;case 20:break;case 21:break;default:throw Error(n(156,b.tag));
}b=null;}c=V;if(1===W||1!==c.childExpirationTime){e=0;for(f=c.child;null!==f;)d=f.expirationTime,g=f.childExpirationTime,d>e&&(e=d),g>e&&(e=g),f=f.sibling;c.childExpirationTime=e;}if(null!==b)return b;null!==a&&0===(a.effectTag&2048)&&(null===a.firstEffect&&(a.firstEffect=V.firstEffect),null!==V.lastEffect&&(null!==a.lastEffect&&(a.lastEffect.nextEffect=V.firstEffect),a.lastEffect=V.lastEffect),1<V.effectTag&&(null!==a.lastEffect?a.lastEffect.nextEffect=V:a.firstEffect=V,a.lastEffect=V));}else {b=Me(V);if(null!==b)return b.effectTag&=2047,b;null!==a&&(a.firstEffect=a.lastEffect=null,a.effectTag|=2048);}b=V.sibling;if(null!==b)return b;V=a;}while(null!==V);X===tf&&(X=yf);return null}function $f(a){var b=a.expirationTime;a=a.childExpirationTime;return b>a?b:a}function ag(a){var b=fc();hc(99,jg.bind(null,a,b));return null}
...
const render_border_1 = __importDefault$8(renderBorder);
...
const natives = [].concat(
  require$$0__default$2['default'].builtinModules,
  'bootstrap_node',
  'node',
...
const Text = ({ color, backgroundColor, dimColor, bold, italic, underline, strikethrough, inverse, wrap, children }) => {
    ...
    return (react_1$1.default.createElement("ink-text", { style: { flexGrow: 0, flexShrink: 1, flexDirection: 'row', textWrap: wrap }, internal_transform: transform }, children));
};
...
const ErrorOverview = ({ error }) => {
    ...
    return (react_1$2.default.createElement(Box_1$1.default, { flexDirection: "column", padding: 1 },
        react_1$2.default.createElement(Box_1$1.default, null,
            react_1$2.default.createElement(Text_1$1.default, { backgroundColor: "red", color: "white" },
                ' ',
                "ERROR",
                ' '),
            react_1$2.default.createElement(Text_1$1.default, null,
                " ",
                error.message)),
        origin && (react_1$2.default.createElement(Box_1$1.default, { marginTop: 1 },
            react_1$2.default.createElement(Text_1$1.default, { dimColor: true },
                origin.file,
                ":",
                origin.line,
                ":",
                origin.column))),
        origin && excerpt && (react_1$2.default.createElement(Box_1$1.default, { marginTop: 1, flexDirection: "column" }, excerpt.map(({ line, value }) => (react_1$2.default.createElement(Box_1$1.default, { key: line },
            react_1$2.default.createElement(Box_1$1.default, { width: lineWidth + 1 },
                react_1$2.default.createElement(Text_1$1.default, { dimColor: line !== origin.line, backgroundColor: line === origin.line ? 'red' : undefined, color: line === origin.line ? 'white' : undefined },
                    String(line).padStart(lineWidth, ' '),
                    ":")),
            react_1$2.default.createElement(Text_1$1.default, { key: line, backgroundColor: line === origin.line ? 'red' : undefined, color: line === origin.line ? 'white' : undefined }, ' ' + value)))))),
        error.stack && (react_1$2.default.createElement(Box_1$1.default, { marginTop: 1, flexDirection: "column" }, error.stack
            .split('\n')
            .slice(1)
            .map(line => {
            const parsedLine = stackUtils$1.parseLine(line);
            // If the line from the stack cannot be parsed, we print out the unparsed line.
            if (!parsedLine) {
                return (react_1$2.default.createElement(Box_1$1.default, { key: line },
                    react_1$2.default.createElement(Text_1$1.default, { dimColor: true }, "- "),
                    react_1$2.default.createElement(Text_1$1.default, { dimColor: true, bold: true }, line)));
            }
            return (react_1$2.default.createElement(Box_1$1.default, { key: line },
                react_1$2.default.createElement(Text_1$1.default, { dimColor: true }, "- "),
                react_1$2.default.createElement(Text_1$1.default, { dimColor: true, bold: true }, parsedLine.function),
                react_1$2.default.createElement(Text_1$1.default, { dimColor: true, color: "gray" },
                    ' ',
                    "(",
                    parsedLine.file,
                    ":",
...
class App extends react_1$3.PureComponent {
    ...
    render() {
        return (react_1$3.default.createElement(AppContext_1$1.default.Provider, { value: {
                exit: this.handleExit
            } },
            react_1$3.default.createElement(StdinContext_1$1.default.Provider, { value: {
                    stdin: this.props.stdin,
                    setRawMode: this.handleSetRawMode,
                    isRawModeSupported: this.isRawModeSupported(),
                    internal_exitOnCtrlC: this.props.exitOnCtrlC
                } },
                react_1$3.default.createElement(StdoutContext_1$1.default.Provider, { value: {
                        stdout: this.props.stdout,
                        write: this.props.writeToStdout
                    } },
                    react_1$3.default.createElement(StderrContext_1$1.default.Provider, { value: {
                            stderr: this.props.stderr,
                            write: this.props.writeToStderr
                        } },
                        react_1$3.default.createElement(FocusContext_1$1.default.Provider, { value: {
                            ...
                            } }, this.state.error ? (react_1$3.default.createElement(ErrorOverview_1$1.default, { error: this.state.error })) : (this.props.children)))))));
    }
    componentDidMount() {
        cli_cursor_1$1.default.hide(this.props.stdout);
    }
    componentWillUnmount() {
        cli_cursor_1$1.default.show(this.props.stdout);
...
class Ink {
    constructor(options) {
        ...
        this.rootNode.onRender = options.debug
            ? this.onRender
            : lodash_1__default['default'].throttle(this.onRender, 32, {
                leading: true,
                trailing: true
            });
        ...
        this.throttledLog = options.debug
            ? this.log
            : lodash_1__default['default'].throttle(this.log, undefined, {
                leading: true,
                trailing: true
            });
    ...
    render(node) {
        const tree = (react_1$4.default.createElement(App_1$1.default, { stdin: this.options.stdin, stdout: this.options.stdout, stderr: this.options.stderr, writeToStdout: this.writeToStdout, writeToStderr: this.writeToStderr, exitOnCtrlC: this.options.exitOnCtrlC, onExit: this.unmount }, node));
...
const Static = (props) => {
    ...
    const style = react_1$5.useMemo(() => (Object.assign({ position: 'absolute', flexDirection: 'column' }, customStyle)), [customStyle]);
...
const Transform = ({ children, transform }) => {
    ...
    return (react_1$6.default.createElement("ink-text", { style: { flexGrow: 0, flexShrink: 1, flexDirection: 'row' }, internal_transform: transform }, children));
};
 ...
 */
const Newline = ({ count = 1 }) => (react_1$7.default.createElement("ink-text", null, '\n'.repeat(count)));
 ...
 */
const Spacer = () => react_1$8.default.createElement(Box_1$2.default, { flexGrow: 1 });
...
const useFocus = ({ isActive = true, autoFocus = false } = {}) => {
    const { isRawModeSupported, setRawMode } = use_stdin_1$1.default();
    const { activeId, add, remove, activate, deactivate } = react.useContext(FocusContext_1$2.default);
...
Object.defineProperty(exports, "useApp", { enumerable: true, get: function () { return useApp_1.default; } });

Object.defineProperty(exports, "useStdin", { enumerable: true, get: function () { return useStdin_1.default; } });

Object.defineProperty(exports, "useStdout", { enumerable: true, get: function () { return useStdout_1.default; } });

Object.defineProperty(exports, "useStderr", { enumerable: true, get: function () { return useStderr_1.default; } });

Object.defineProperty(exports, "useFocus", { enumerable: true, get: function () { return useFocus_1.default; } });

Object.defineProperty(exports, "useFocusManager", { enumerable: true, get: function () { return useFocusManager_1.default; } });

Object.defineProperty(exports, "measureElement", { enumerable: true, get: function () { return measureElement.default; } });
