...
const axios = require(`axios`); // This should be replaced with the solution for https://github.com/gatsbyjs/gatsby/issues/24220
...
const buildResponsiveSizes = async ({
  ...
  const imageURL = new URL(imageUrl.indexOf(`/`) === 0 ? `https:${imageUrl}` : imageUrl);
  const {
    width,
    height,
    density
